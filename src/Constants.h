...
#define EVT_LIGHT_RESET_OVERRIDE 35
...
#define EVT_BUZZER_PASSWORD_CHANGE 71
#define EVT_BUZZER_PASSWORD_ACCEPT 72
#define EVT_BUZZER_DOOR_OPEN 73
#define EVT_BUZZER_DOOR_CLOSE 74
#define EVT_BUZZER_ANGRY_SOUND 75

// Child lock event types
#define EVT_CHILD_LOCK_RELEASE 76
#define EVT_CHILD_LOCK_ENGAGE 77
#define EVT_CHILD_LOCK_TIMEOUT_RESET 78
